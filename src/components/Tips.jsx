...
function Tips(props) {
  return (
    <section id="tips">
      <h2>
        Advice to reduce your CO<sub>2</sub> emissions
      </h2>
      <div className="tips_container">
        ...
        <TipsBox
          title="Emails"
          text="Unsubscribe to newsletter you don't read. Don’t use reply all unless necessary."
        />
        ...
        <TipsBox
          ...
          text="Minimize unnecessary energy use by avoiding streaming videos you’re not actually watching."
        />
